...
def build_game(page: ft.Page, username="guest", uid=None, id_token=None):
    ...
    tab_buttons_list = [
        ...
        ft.TextButton("📊 Стата", on_click=show_stats),
        ft.TextButton("🏆 Лидеры", on_click=show_leaderboard),
    ]
    if username == ADMIN_USERNAME:
        tab_buttons_list.append(ft.TextButton("🛠 Админ", on_click=show_admin))

    tab_buttons = ft.Row(
        alignment=ft.MainAxisAlignment.CENTER,
        wrap=True,
        controls=tab_buttons_list,
    )
